...
// BLE Service
static BLEUUID ServiceUUID("92053ecb-cd1b-4819-aed4-e3e516d14789");
static BLEUUID temperatureCharacteristicUUID("6781f563-0dc3-4a2a-bd58-ad5ce98c6b22");
static BLEUUID humidityCharacteristicUUID("89beec2d-0612-4ec2-a1c7-9f19539aff86");
static BLEUUID dataCharacteristicUUID("e39d897c-ebca-473a-87ed-03a6bf9f62c6");
...
bool connectToServer(BLEClient* pclient)
{
  ...
  Serial.println("RECEIVED temperature and humidity and ready to send data");
  connected = true;
  return true;
}
    ...
    if (Serial.available() > 0) {
      ...
      switch (c) {
        case 'd' :
          ...
          break;
        case 't' :
          temp = temperatureCharacteristic->readValue();
...
void sendData(String stringToSend)
{
  ...
  if (connected) {
    ...
    dataCharacteristic->writeValue(stringToSend.c_str(), stringToSend.length());
    Serial.print("<<< ");
