...
void setup()
{
    ...
    BLE2902* m2_BLE2902 = new BLE2902();
    m1_BLE2902->setNotifications(true);
    m1_BLE2902->setIndications(true);

    pCharacteristic_humi->addDescriptor(m2_BLE2902);
...
void loop()
{
    ...
    if (deviceConnected) {
        ...
        // pCharacteristic_humi->notify(true);
        // delay(50);
       // pCharacteristic_humi->indicate();
       // delay(50);
        // pCharacteristic_temp->notify(true);
        // delay(50);
        pCharacteristic_temp->indicate();
        delay(50);
    }
